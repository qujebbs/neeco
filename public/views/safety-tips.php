        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            <article class="blog-details">
              <div class="post-img">
                <img src="public/assets/img/safety tips.jpg" alt="Safety Tips" class="img-fluid" style="height: 150%; width: 110%;">
              </div>
                ...
                <div class="mt-3">
                  <?php foreach ($news as $item) : ?>  
                    <div class="post-item mt-3">
                      ...
                      <div>
                        <h4><a href="/neeco2/home?section=blog-details&news_id=<?php echo htmlspecialchars($item['newsId']); ?>"><?php echo htmlspecialchars($item['newsTitle']); ?></a></h4>
