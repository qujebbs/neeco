      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-md-6">
            ...
            <div class="post-img">
  <a href="<?php echo $news['staff_picture']; ?>" data-lightbox="image">
    <img src="<?php echo $news['staff_picture']; ?>" alt="" class="img-fluid">
  </a>
</div>
              <p class="post-category"><?php echo $news['staff_name']; ?></p>

              <p class="post-category" style="font-size: 12px; color: #000;"><?php echo $news['staff_position']; ?></p>
