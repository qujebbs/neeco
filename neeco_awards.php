        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <div class="post-img">
               <img src="assets/img/awardssss.png" alt="" style="width: 100%; height: 100%;">
              </div>

              <h2 class="title">NEECO ll AREA 1 AWARDS</h2>
    ...
    <?php foreach ($awards as $dist) : ?>
        <tr>
            ...
            <td style="padding-left: 10px;">
                ...
                <?php echo date('F j, Y', strtotime($dist['award_date'])); ?>
                </p>
            </td>
            <td style="padding-left: 10px;">
                <p style="font-size: 18px; font-weight: 10;">
                    <?php echo $dist['award_type']; ?> 
                </p>
            </td>
            <td style="padding-left: 10px;">
                <p style="font-size: 18px; font-weight: 10;">
                    <?php echo $dist['award_name']; ?>
                </p>
            </td>
            <td style="padding-left: 10px;">
                <p style="font-size: 18px; font-weight: 10;">
                <?php echo $dist['award_from']; ?>
                </p>
            </td>
        </tr>
    <?php endforeach; ?>
