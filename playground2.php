<?php   include ("views/fragments/header.php");
        include ("views/fragments/breadcrumbs.php"); ?>
...
<head>
    ...
    <title>Terms and Conditions - NEECO II AREA 1</title>
                ...
                <div class="content-section">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <ul class="list-custom">
                                        <li>For NEECO II-AREA1 Online website - Navigate to "My Portal Account" and click on "Delete Portal Account". For NEECO II-AREA1 Mobile - Navigate to "Settings" > "Account" then select "Delete Account".</li>
                                        <li>Click "Continue". A verification code will be sent to your registered email.</li>
                                    </ul>
                    ...
                    <div>
                        ...
                        <ol class="list-group list-group-numbered mb-3">
                            <li class="list-group-item">Go to your Dashboard then click on "My Portal Account" on the menu.</li>
                            <li class="list-group-item">Click on "Delete Portal Account" and click "Continue".</li>
                            <li class="list-group-item">Enter the verification code that will be sent to your email.</li>
                            <li class="list-group-item">Confirm the deletion by pressing "Continue Deletion" button.</li>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <ol class="list-group list-group-numbered mb-0">
                                    <li class="list-group-item">Go to your Facebook Account's Setting & Privacy. Click "Settings"</li>
                                    ...
                                    <li class="list-group-item">Search and click "Official NEECO II-AREA1 Portal" in the search bar.</li>
                                    <li class="list-group-item">Scroll and click "Remove".</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <ol class="list-group list-group-numbered mb-0">
                                    ...
                                    <li class="list-group-item">Under "Third-party apps with account access," select "Manage third-party access".</li>
                                    <li class="list-group-item">Select NEECO II-AREA1 Portal or NEECO II-AREA1 Mobile or service you want to remove.</li>
                                    <li class="list-group-item">Select "Remove Access".</li>
                                </ol>
                            </div>
                        </div>
